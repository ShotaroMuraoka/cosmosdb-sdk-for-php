...
final class GetChangeFeedCommand implements CommandInterface
{
    private const string METHOD = 'GET';
    private const string RESOURCE_TYPE = 'docs';
    private const string RESOURCE_LINK = 'dbs/%s/colls/%s';
    private const string ENDPOINT = '/dbs/%s/colls/%s/docs';
    ...
    public function execute(RequestDtoInterface $request): Result
    {
        ...
        $headers = array_merge($headers, ['x-ms-documentdb-change-feed' => 'true'], $request->headers);
